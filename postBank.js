...
const list = () => {
  return [...data]; //Make a shallow copy of our orginal data
};

const find = (id) => {
  const post = data.find((post) => post.id === +id); //Look for the id that matches in our array
  return { ...post }; //shallow copy to prevent alerting the original data
};
